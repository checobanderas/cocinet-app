...
export const ComandaCancelModal: React.FC<ComandaCancelModalProps> = ({
  ...
  comandaCancelPin,
  comandaCancelReason,
  handleMarkEntireComandaForCancellation,
        ...
        >
          ...
          <IonButtons slot="end">
            <IonButton
              ...
              onClick={() => setComandaToCancel(null)}
            >
              Cerrar
            </IonButton>
          </IonButtons>
            ...
            <div className="space-y-2">
              {[
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl font-semibold text-slate-800 transition active:scale-98 shadow-sm disabled:opacity-60"
                >
                  {reason}
                </button>
              ))}
          ...
          <div className="space-y-4">
            <div className="bg-rose-50 border border-rose-200 p-3 rounded-2xl flex justify-between items-center">
              ...
              <button
                ...
                className="bg-rose-100 hover:bg-rose-200 text-rose-800 font-bold text-[11px] px-2.5 py-1 rounded-lg border-none cursor-pointer disabled:opacity-50"
              >
                Cambiar
              </button>
            </div>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  if (comandaToCancel !== null) {
                    ...
                    try {
                      await handleMarkEntireComandaForCancellation(
                        comandaToCancel,
                        comandaCancelReason
                      );
                      setComandaToCancel(null);
                ...
                className={`w-full flex items-center justify-center gap-2 py-3.5 text-white font-black text-sm rounded-xl transition shadow-md border-none ${
                  isProcessing
                    ? "bg-amber-400 cursor-not-allowed opacity-80"
                    : "bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 active:scale-98 cursor-pointer"
                }`}
              >
                {isProcessing ? (
                  <>
