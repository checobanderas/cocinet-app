...
export const ManageInvoicingView: React.FC<ManageInvoicingViewProps> = ({
  ...
  // Filtered List based on Search & Branch
  ...
  }, [invoices, selectedBranchId, searchQuery]);
    ...
    <IonPage className="bg-slate-950 text-slate-100">
      ...
      <IonContent className="bg-slate-950" fullscreen>
        <div className="max-w-7xl mx-auto p-4 md:p-6 pb-24">
          {/* Header & Tenant Badge */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 p-5 rounded-2xl border border-slate-800 shadow-xl">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold border border-slate-700 shadow-sm transition active:scale-95 disabled:opacity-50 cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-lg shadow-emerald-600/20 transition active:scale-95 cursor-pointer"
              >
          ...
          {/* ========================================================= */}
          {/* 6 DASHBOARD WIDGET CARDS (As requested by user)          */}
          {/* ========================================================= */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            <motion.div
              ...
              className={`p-5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden ${
                activeTab === "no_timbradas"
                  ? "bg-gradient-to-br from-amber-950/80 via-slate-900 to-slate-900 border-amber-500 shadow-lg shadow-amber-500/20"
            ...
            <motion.div
              ...
              className={`p-5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden ${
                activeTab === "timbradas"
                  ? "bg-gradient-to-br from-emerald-950/80 via-slate-900 to-slate-900 border-emerald-500 shadow-lg shadow-emerald-500/20"
            ...
            <motion.div
              ...
              className={`p-5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden ${
                activeTab === "requieren_datos"
                  ? "bg-gradient-to-br from-cyan-950/80 via-slate-900 to-slate-900 border-cyan-500 shadow-lg shadow-cyan-500/20"
            ...
            <motion.div
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => setActiveTab("multi_sucursal")}
              className={`p-5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden ${
                activeTab === "multi_sucursal"
                  ? "bg-gradient-to-br from-indigo-950/80 via-slate-900 to-slate-900 border-indigo-500 shadow-lg shadow-indigo-500/20"
            ...
            <motion.div
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => setActiveTab("emisor_csd")}
              className={`p-5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden ${
                activeTab === "emisor_csd"
                  ? "bg-gradient-to-br from-violet-950/80 via-slate-900 to-slate-900 border-violet-500 shadow-lg shadow-violet-500/20"
            ...
            <motion.div
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => setActiveTab("reporte_excel")}
              className={`p-5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden ${
                activeTab === "reporte_excel"
                  ? "bg-gradient-to-br from-blue-950/80 via-slate-900 to-slate-900 border-blue-500 shadow-lg shadow-blue-500/20"
