...
def extract_render_function(function_name, component_name):
    ...
    # Let's rebuild the content string and find the exact index of `=>` in it to start counting!
    full_str = '\n'.join(lines)
    
    # regex to find exact start of function in full string
    ...
    start_pos = start_match.end() - 1  # points to the [({] character
    ...
    # inner body is between start_pos and end_pos
