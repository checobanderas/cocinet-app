...
<button onclick="window.close();" class='btn btn-dark btn-outline btn-rounded m-b-10 m-l-5 form-control' style="
    line-height: 12px;
    width: auto;
    font-size: 8pt;
    font-family: tahoma;
...
$sql='select * from ( 
SELECT `ID_FACTURA`, `NOMBRE`, `FOLIO`, `FECHA`, `SUBTOTAL`, `IVA`, `TOTAL`, UUID, F.estado, ID FROM facturas F INNER JOIN clientes C on F.ID_CLIENTE= C.ID 
) F where ID = '.$_GET['ID'] ;
