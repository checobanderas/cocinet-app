...
extract_render_function('renderSwitchingTenantOverlay', 'SwitchingTenantOverlayView')
extract_render_function('renderUserHeaderInfo', 'UserHeaderInfoView')
extract_render_function('renderMaterialHeader', 'MaterialHeaderView')
extract_render_function('renderLogin', 'LoginView')
extract_render_function('renderCancellationPinPad', 'CancellationPinPadView')
extract_render_function('renderClosedAccountsList', 'ClosedAccountsListView')
extract_render_function('renderDeliveryPanel', 'DeliveryPanelView')
extract_render_function('renderReviewItem', 'ReviewItemView')
extract_render_function('renderPrecuentaItem', 'PrecuentaItemView')
extract_render_function('renderReview', 'ReviewView')
extract_render_function('renderUsersManagementPanel', 'UsersManagementPanelView')
extract_render_function('renderSuppliers', 'SuppliersView')
extract_render_function('renderCustomers', 'CustomersView')
extract_render_function('renderExpenses', 'ExpensesView')
extract_render_function('renderGestionCuentas', 'GestionCuentasView')
extract_render_function('renderCorteTabla2', 'CorteTabla2View')
extract_render_function('renderReporteMovimientos', 'ReporteMovimientosView')
