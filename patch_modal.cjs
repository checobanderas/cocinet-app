...
const newModalCode = `const renderProductCrudModal = () => {
          ...
          <div className="p-6 bg-[#1e293b] text-white flex justify-between items-center shrink-0">
            <div>
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
                Panel de Administraci�n de Men�
              </p>
            </div>
            <button 
              ...
              <div className="w-full md:w-2/5 bg-slate-100 border-r border-slate-200 p-6 overflow-y-auto h-full">
                <div className="mb-4">
                  ...
                  <p className="text-[10px] text-slate-500 font-bold mt-1">
                    (Opcional) Selecciona d�nde aplicar�s los cambios. Deja vac�o para aplicar solo en la sucursal actual.
                  </p>
                </div>
...
content = content.substring(0, startIdx) + newModalCode + "\n  " + content.substring(endIdx);
