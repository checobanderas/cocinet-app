...
# ──── FolioModal ────────────────────────────────────────────────────────
folio_header = '''import React from 'react';
...
folio_props = '''          showFolioModal={showFolioModal}
...
# ──── InvoicePhoneModal ────────────────────────────────────────────────────────
invoice_header = '''import React from 'react';
import { IonModal, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonIcon, IonItem, IonLabel, IonInput } from '@ionic/react';
...
invoice_props = '''          showInvoicePhoneModal={showInvoicePhoneModal}
...
print('\nDone! Extracted FolioModal + InvoicePhoneModal.')
